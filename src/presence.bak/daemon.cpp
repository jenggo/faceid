...
int main(int argc, char* argv[]) {
    ...
    // Log clear startup completion message
    logger.info("========================================");
    logger.info("FaceID Presence Detection: NOW MONITORING");
    logger.info("  State: " + detector.getStateString());
    logger.info("  Camera: " + camera_device);
    logger.info("  Inactive threshold: " + std::to_string(inactive_threshold) + "s");
    logger.info("  Input devices: Keyboard, Mouse, Touchpad, Bluetooth");
    logger.info("========================================");
    ...
    // Graceful shutdown
    logger.info("========================================");
    logger.info("FaceID Presence Detection: SHUTTING DOWN");
    logger.info("========================================");
    ...
    logger.info("========================================");
    logger.info("FaceID Presence Detection: STOPPED");
    logger.info("========================================");
